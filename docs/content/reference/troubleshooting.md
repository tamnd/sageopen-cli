...
Most of these come down to network reality or how sageopen serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

sageopen rate-limits like any public site. sageopen already paces
...
Where a surface is gated, sageopen reads a cookie or token you supply
...
`sageopen`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what sageopen actually did
