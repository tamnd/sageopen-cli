// Package cli builds the sageopen command tree on top of the sageopen library.
package cli
...
func Root() *cobra.Command {
	app := &App{cfg: sageopen.DefaultConfig()}

	root := &cobra.Command{
		Use:           "sageopen",
		Short:         "Browse SAGE open-access journals",
		SilenceUsage:  true,
		SilenceErrors: true,
...
func (a *App) setup() error {
	...
	a.client = sageopen.NewClient(a.cfg)
	return nil
}
